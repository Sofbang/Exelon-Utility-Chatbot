...
module.exports = function (service) {
    ...
    service.get('/mobile/custom/euchatbotapi/outage/query', function (req, res) {
    ...
    service.get('/mobile/custom/euchatbotapi/outage', function (req, res) {
    ...
    service.get('/mobile/custom/euchatbotapi/bill/lookup', function (req, res) {
        var PhoneNumber = req.query["PhoneNumber"];
        var AccountNumber = req.query["AccountNumber"];
