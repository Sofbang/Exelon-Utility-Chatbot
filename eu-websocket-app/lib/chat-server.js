...
function init(config, httpServer) {
    ...
    var BGEChannel = {
        "name": "BGE",
        "description": "BGE",
        "secretKey": process.env.GOOGLE_BGE_CHANNEL_SECRET || "DdOyuhOUKHoOhQGYJbYihCzUv8gbOx38",
        "uri": process.env.GOOGLE_BGE_CHANNEL_URL || "https://exelonchatbotstageBOTSCON-exelon001omce.uscom-central-1.oraclecloud.com:443/connectors/v1/tenants/idcs-fce88a53879a43eb9ff782e4a0cd0513/listeners/webhook/channels/E4792F91-0252-4156-8638-57BAB4D1A56C",
        "type": "webhook",
        "tenantId": process.env.GOOGLE_BGE_TENANT_ID || "idcs-fce88a53879a43eb9ff782e4a0cd0513",
        "id": process.env.GOOGLE_BGE_CHANNEL_ID || "E4792F91-0252-4156-8638-57BAB4D1A56C"
    }

    var COMEDChannel = {
        "name": "COMED",
        "description": "COMED",
        "secretKey": process.env.GOOGLE_COMED_CHANNEL_SECRET || "irLCyFwLVksmakJCSK7187FBWV2wVrrx",
        "uri": process.env.GOOGLE_COMED_CHANNEL_URL || "https://exelonchatbotstageBOTSCON-exelon001omce.uscom-central-1.oraclecloud.com:443/connectors/v1/tenants/idcs-fce88a53879a43eb9ff782e4a0cd0513/listeners/webhook/channels/549A70C3-ED24-4443-9637-D8F91E66FADB",
        "type": "webhook",
        "tenantId": process.env.GOOGLE_COMED_TENANT_ID || "idcs-fce88a53879a43eb9ff782e4a0cd0513",
        "id": process.env.GOOGLE_COMED_CHANNEL_ID || "549A70C3-ED24-4443-9637-D8F91E66FADB"
    }

    tempDB.bots.push(BGEChannel);
    tempDB.bots.push(COMEDChannel);
